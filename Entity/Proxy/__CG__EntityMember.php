...
class Member extends \Entity\Member implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Member' . "\0" . 'id', '' . "\0" . 'Entity\\Member' . "\0" . 'firstname', '' . "\0" . 'Entity\\Member' . "\0" . 'lastname', '' . "\0" . 'Entity\\Member' . "\0" . 'picture', '' . "\0" . 'Entity\\Member' . "\0" . 'project'];
        }
